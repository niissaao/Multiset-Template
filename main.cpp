...
ostream &operator<<(ostream& output, Multiset < int > const& m) //in caz de elementele sunt de tip int
{
...
ostream &operator<<(ostream& output, Multiset < float > const& m) //in caz de elementele sunt de tip float
{
...
ostream &operator<<(ostream& output, Multiset < char > const& m) //in caz de elementele sunt de tip char
{
